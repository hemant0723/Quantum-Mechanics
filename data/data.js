...
window.DATA = {
  course: {
    ...
    evaluation: [
      { item: "Homework (12 assignments)", weight: 60 },
  ...
  attendance: [
    ...
    // 2025-10-13 (Make-up class): Present (all students)
    { date: "2025-10-13", student: "D14222013", status: "Present" }, // Wazid Ahmed
    { date: "2025-10-13", student: "D14222014", status: "Present" }, // Paawan Chandrakanth
    { date: "2025-10-13", student: "D14222016", status: "Present" }, // Le Thi Phuong Thao
    { date: "2025-10-13", student: "D14222017", status: "Present" }, // Tanzeela Asghar
    { date: "2025-10-13", student: "D14222018", status: "Present" }, // Rehan Abid
    { date: "2025-10-13", student: "D14222020", status: "Present" }, // Tsegaye Menberu Genzebu
    { date: "2025-10-13", student: "D14222022", status: "Present" }, // Ujjal Bikash Parashar
    { date: "2025-10-13", student: "D13222018", status: "Present" }, // YOU-CHEN LIN
    { date: "2025-10-13", student: "D13222019", status: "Present" }, // Yu-Tse Tsai
    { date: "2025-10-13", student: "D13222022", status: "Present" }, // Muhammad Roman
    { date: "2025-10-13", student: "114011862", status: "Present" }, // Chung Ling Hsuan
  ...
  assignments: [
    ...
    { id:"H4", title:"Homework 4", subject:"Quantum Mechanics", assigned:"2025-10-09", due:"2025-10-16", max: 5 },
    { id:"H5", title:"Homework 5", subject:"Quantum Mechanics", assigned:"2025-10-16", due:"2025-10-23", max: 5 },
    { id:"H6", title:"Homework 6", subject:"Quantum Mechanics", assigned:"2025-10-23", due:"2025-10-30", max: 5 },
    { id:"H7", title:"Homework 7", subject:"Quantum Mechanics", assigned:"2025-10-30", due:"2025-11-06", max: 5 },
    { id:"H8", title:"Homework 8", subject:"Quantum Mechanics", assigned:"2025-11-06", due:"2025-11-15", max: 5 },
    { id:"H9", title:"Homework 9", subject:"Quantum Mechanics", assigned:"2025-11-13", due:"2025-11-20", max: 5 },
    { id:"H10", title:"Homework 10", subject:"Quantum Mechanics", assigned:"2025-11-20", due:"2025-11-27", max: 5 },
    { id:"H11", title:"Homework 11", subject:"Quantum Mechanics", assigned:"2025-11-27", due:"2025-12-04", max: 5 },
    { id:"H12", title:"Homework 12", subject:"Quantum Mechanics", assigned:"2025-12-04", due:"2025-12-11", max: 5 },
  ...
  marks: [
    ...
    // HW-4 (max 5)
    { assignmentId:"H4", student:"D14222013", marks:5, max:5 },
    { assignmentId:"H4", student:"D14222014", marks:5, max:5 },
    { assignmentId:"H4", student:"D14222016", marks:5, max:5 },
    { assignmentId:"H4", student:"D14222017", marks:5, max:5 },
    { assignmentId:"H4", student:"D14222018", marks:5, max:5 },
    { assignmentId:"H4", student:"D14222020", marks:5, max:5 },
    { assignmentId:"H4", student:"D14222022", marks:5, max:5 },
    { assignmentId:"H4", student:"D13222018", marks:5, max:5 },
    { assignmentId:"H4", student:"D13222019", marks:5, max:5 },
    { assignmentId:"H4", student:"D13222022", marks:5, max:5 },
    { assignmentId:"H4", student:"114011862", marks:5, max:5 },

    // HW-5 (max 5)
    { assignmentId:"H5", student:"D14222013", marks:5, max:5 },
    { assignmentId:"H5", student:"D14222014", marks:5, max:5 },
    { assignmentId:"H5", student:"D14222016", marks:5, max:5 },
    { assignmentId:"H5", student:"D14222017", marks:5, max:5 },
    { assignmentId:"H5", student:"D14222018", marks:5, max:5 },
    { assignmentId:"H5", student:"D14222020", marks:5, max:5 },
    { assignmentId:"H5", student:"D14222022", marks:5, max:5 },
    { assignmentId:"H5", student:"D13222018", marks:5, max:5 },
    { assignmentId:"H5", student:"D13222019", marks:5, max:5 },
    { assignmentId:"H5", student:"D13222022", marks:5, max:5 },
    { assignmentId:"H5", student:"114011862", marks:5, max:5 },
    ...
    // HW-6 (max 5)
    { assignmentId:"H6", student:"D14222013", marks:5, max:5 },
    { assignmentId:"H6", student:"D14222014", marks:5, max:5 },
    { assignmentId:"H6", student:"D14222016", marks:5, max:5 },
    { assignmentId:"H6", student:"D14222017", marks:5, max:5 },
    { assignmentId:"H6", student:"D14222018", marks:5, max:5 },
    { assignmentId:"H6", student:"D14222020", marks:5, max:5 },
    { assignmentId:"H6", student:"D14222022", marks:5, max:5 },
    { assignmentId:"H6", student:"D13222018", marks:5, max:5 },
    { assignmentId:"H6", student:"D13222019", marks:5, max:5 },
    { assignmentId:"H6", student:"D13222022", marks:5, max:5 },
    { assignmentId:"H6", student:"114011862", marks:5, max:5 },

    // HW-7 (max 5)
    { assignmentId:"H7", student:"D14222013", marks:5, max:5 },
    { assignmentId:"H7", student:"D14222014", marks:5, max:5 },
    { assignmentId:"H7", student:"D14222016", marks:5, max:5 },
    { assignmentId:"H7", student:"D14222017", marks:5, max:5 },
    { assignmentId:"H7", student:"D14222018", marks:5, max:5 },
    { assignmentId:"H7", student:"D14222020", marks:5, max:5 },
    { assignmentId:"H7", student:"D14222022", marks:5, max:5 },
    { assignmentId:"H7", student:"D13222018", marks:5, max:5 },
    { assignmentId:"H7", student:"D13222019", marks:5, max:5 },
    { assignmentId:"H7", student:"D13222022", marks:5, max:5 },
    { assignmentId:"H7", student:"114011862", marks:5, max:5 },
